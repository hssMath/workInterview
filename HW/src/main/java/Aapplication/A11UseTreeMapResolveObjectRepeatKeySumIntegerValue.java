 ...
 */
public class A11UseTreeMapResolveObjectRepeatKeySumIntegerValue {
    /**
    ...
    public static void main(String[] args) {
        ...
        addMap(hashMap, new Student(1,178), 3);
        addMap(hashMap, new Student(2,165), 1);
        addMap(hashMap, new Student(3,185), 4);
        addMap(hashMap, new Student(4,176), 2);
